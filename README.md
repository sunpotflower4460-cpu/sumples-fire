...
- 起動直後に `Sumples Fire` のタイトルカードを表示
- アプリ名、説明、主要アクションを最初の画面で見せる
- 初めて開いた人がメモ帳アプリだと分かるようにする

## 保存仕様

- メモは端末内の `localStorage` に保存します
- アプリやブラウザを閉じて開き直してもメモは残ります
...
- Phase 15: 検索 / 並び替え / カテゴリ表示
- Phase 16: 独自削除ダイアログ
- Phase 17: Capacitor依存関係の追加とiOSプロジェクト生成
